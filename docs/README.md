...
| [java-creator.md](java-creator.md) | `java-creator.lua` | IntelliJ-style new-file GUI (**not currently loaded**) |
...
| [inactive-modules.md](inactive-modules.md) | `autoformat.lua`, `null-ls.lua`, `transparency.lua`, `java-creator.lua` | Files present in the repo but **not loaded** |
