...
| `lua/ajay/java-creator.lua` | **[docs/java-creator.md](docs/java-creator.md)** | IntelliJ-style new-file GUI — *not currently loaded* |
...
| `lua/ajay/autoformat.lua` | **[docs/inactive-modules.md](docs/inactive-modules.md)** | Superseded by conform — *not loaded* |
| `lua/ajay/null-ls.lua` | **[docs/inactive-modules.md](docs/inactive-modules.md)** | Superseded by conform — *not loaded* |
| `lua/ajay/transparency.lua` | **[docs/inactive-modules.md](docs/inactive-modules.md)** | Transparent background toggle — *not loaded* |
...
| **[docs/inactive-modules.md](docs/inactive-modules.md)** | Files in the repo that are not loaded |
...
# 2. Core
brew install neovim git ripgrep fd node python3 lazygit unzip curl cmake
...
sudo pacman -S neovim git ripgrep fd base-devel cmake unzip curl \
               nodejs npm python-pynvim jdk21-openjdk lazygit
